...
namespace TomatoPHP\TomatoForms\Console;
...
class GenerateForm extends Command
{
     ...
     * @var string
     */
    protected $name = 'tomato-form:generate';
    ...
    public function handle()
    {
        ...
        $name = $this->ask('please input your form name');
